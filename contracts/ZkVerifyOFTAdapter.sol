...
/**
 * @title ZkVerifyOFTAdapter
 * @dev ZkVerifyOFTAdapter is a contract that adapts native currency to the OFT functionality.
 *
 ...
 */
contract ZkVerifyOFTAdapter is NativeOFTAdapter {
    constructor(
